	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="card shadow">
				<div class="card-body">
					<!-- enctype="multipart/form-data" : 첨부파일 서버로 전달 -->
...
<!-- 
Spring version 3.1까지는 이미지 처리에 CommonsMultipartResolver 혹은 CosMultipartResolver 사용. 
-> 현재는 StandardServletMultipartResolver 사용.
-->